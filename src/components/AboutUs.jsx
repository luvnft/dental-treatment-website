...
const AboutUs = () => {
  return (
    <section className="aboutUsContent px-3 flex max-w-[1180px] mx-auto max-lg:flex-col max-lg:justify-center max-lg:items-center">
      <div className="aboutUsImgSide w-full">
        <div className="aboutUsImgContent max-w-[500px] max-lg:max-w-[300px]  max-lg:mx-auto">
          <img
            src={patientCenteredCare}
            alt="patientCenteredCare"
            className="aboutUsImg w-full max-lg:text-center"
          />
        </div>
      </div>
      <div className="aboutUsInfoSide w-full">
        <h3 className="sectionSubTitle font-semibold text-[20px] text-left text-secondary">
          Satisfy Solution
        </h3>
        <h2 className="sectionMainTitle text-left mb-6 font-semibold text-[36px]">
        ...
        <p className="sectionDesc text-[18px]">
          ...
          highly skilled professionals is here to ensure your dental experience
          is comfortable and stress-free.
        </p>
        <h4 className="sectionInfoTitle font-medium text-[22px] my-2">
          Our Mission
        </h4>
        <p className="sectionDesc text-[18px]">
