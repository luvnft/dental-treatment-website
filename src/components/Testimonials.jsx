...
const Testimonials = () => {
  return (
    <section className="testimonialsContent min-h-[800px] flex flex-col justify-center items-center my-5 ">
      <h3 className="sectionSubTitle font-semibold text-[20px] text-center text-black">
        Satisfy Solution
      </h3>
      ...
      <div className="testimonialsBox flex flex-col justify-center items-center max-w-[1180px] mx-auto p-5">
        <div className="testimonialsBoxImgContent mb-5">
          <img
            ...
            className="testimonialsBoxImg"
          />
        </div>
        <p className="testimonialsDesc font-bold text-[32px] text-center">
          "In an emergency situation, I was amazed by how quickly they
          accommodated me. The dentist's skill and compassion were evident. I'm
          grateful for their prompt care."
        </p>
        <div className="testimonialsBoxPersonInfo text-center mt-5">
          <p className="testimonialsBoxPersonName text-[24px] font-medium text-[#1E1E1E]">
            David Gahan
          </p>
          <p className="testimonialsBoxPersonLocation text-[20px] text-[#1E1E1E]">
            Detroit, Michigan
          </p>
        </div>
      </div>
